    ...
    <div class="ub ub-ver safeCount">
        ...
        <ul class="list ub-f1 ub ub-ver ubt ubb-d">
            ...
            <li class="ub ub-f1 ub-ac ubb ubb-d uinn">
                <label class="ub" for="">新手机号</label>
                <div class="ub ub-f1 uinput"><input class="ub-f1 ulev-3" id="mobile" type="text"  name="" placeholder="请输入新手机号"></div>
            </li>
...
function submit()
{
    ...
    var url = '/index.php?m=User&a=set_new_mobile';
	$.post(url, {'yzm':yzm,'mobile':mobile}, function (r){
		if(r.code==0){
			Zalert(r.msg);
			setTimeout(function(){
