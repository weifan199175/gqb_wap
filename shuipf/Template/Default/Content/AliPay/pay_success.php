...
<div class="cBox">
    ...
    <div class="ub ub-ver paySuccessBox">
        ...
        <div class="succeedd ub ub-ac ub-pc uinn tx-red">恭喜您已支付成功！</div> 
      <div class="tips ub ub-ac ub-pc uinn">您可以返回微信查看订单支付状态！</div>       
       <!--<a class="go-back btn ub ub-fl uinput ub-ac ub-pc ulev-3 uba uc-a1" href="#">返回微信</a>-->        
    </div>
    <!-- /我的订单-支付成功 -->
</div>
<!-- /c -->
