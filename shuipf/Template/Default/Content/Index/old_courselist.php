...
<head>
    ...
    <link rel="stylesheet" href="/statics/default/css/class.min.css">
</head>

<body>
    <div class="classPic">
        <img src="/statics/default/images/class.jpg" alt="">
    </div>
    <!-- nav -->
    ...
    <div class="five">
        <div class="title">
            ...
            <div class="month">五月份</div>
        </div>
        <div class="less">
            <a href="javascript:void(0)">
                <div class="left">
                    <img src="/statics/default/images/gebi.jpg" alt="">
                </div>
                <div class="classInfo">
                    <div class="className">戈壁挑战赛</div>
                    <div class="classTime">5月11-14日 （敦煌）</div>
                </div>
            </a>
        </div>
        <div class="more">
            <a href="javascript:void(0)">
                <div class="left">
                    <img src="/statics/default/images/sheji.jpg" alt="">
                </div>
                <div class="classInfo">
                    <div class="className">《股权设计》</div>
                    <div class="classTime">5月20-21日 （北京）</div>
                    <div class="classPeople"><span>刘少华</span>股权帮创始人</div>
                </div>
            </a>
        </div>
    </div>
    <div class="six">
        <div class="title">
            ...
            <div class="month">六月份</div>
        </div>
        <div class="less">
            <a href="javascript:void(0)">
                <div class="left">
                    <img src="/statics/default/images/sidonghui.jpg" alt="">
                </div>
                <div class="classInfo">
                    <div class="className">私董会会议</div>
                    <div class="classTime">6月9日  （北京）</div>
                </div>
            </a>
        </div>
        <div class="more">
            <a href="javascript:void(0)">
                <div class="left">
                    <img src="/statics/default/images/baopin.jpg" alt="">
                </div>
                <div class="classInfo">
                    <div class="className">《爆品战略》</div>
                    <div class="classTime">6月10-11日 （北京）</div>
                    <div class="classPeople"><span>金错刀</span>联合小米科技顾问</div>
                </div>
            </a>
        </div>
        <div class="more">
            <a href="javascript:void(0)">
                ...
                <div class="classInfo">
                    <div class="className">《股权设计》</div>
                    <div class="classTime">6月24-25日 （北京）</div>
                    <div class="classPeople"><span>刘少华</span>股权帮创始人</div>
                </div>
            </a>
        </div>
    ...
    <div class="seven">
        <div class="title">
            ...
            <div class="month">七月份</div>
        </div>
        <div class="more">
            <a href="javascript:void(0)">
                <div class="left">
                    <img src="/statics/default/images/jiagou.jpg" alt="">
                </div>
                <div class="classInfo">
                    <div class="className">《股权架构设计》</div>
                    <div class="classTime">7月7-9日  （北京）</div>
                    <div class="classPeople"><span>刘少华</span>股权帮创始人</div>
                </div>
            </a>
        </div>
  ...
  <div class="eight">
        <div class="title">
            ...
            <div class="month">八月份</div>
        </div>
        <div class="more">
            <a href="javascript:void(0)">
                <div class="left">
                    <img src="/statics/default/images/siwei.jpg" alt="">
                </div>
                <div class="classInfo">
                    <div class="className">《新物种思维》</div>
                    <div class="classTime">8月12-13日  （北京）</div>
                    <div class="classPeople"><span>刘少华</span>股权帮创始人</div>
                </div>
            </a>
        </div>
        <div class="more">
            <a href="javascript:void(0)">
                ...
                <div class="classInfo">
                    <div class="className">《股权设计》</div>
                    <div class="classTime">8月26-27日  （北京）</div>
                    <div class="classPeople"><span>刘少华</span>股权帮创始人</div>
                </div>
            </a>
        </div>
