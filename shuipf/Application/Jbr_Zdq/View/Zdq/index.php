  ...
  <table width="100%" cellspacing="0">
        <thead>
          <tr>
			...
			<td align="center" width="6%">项目名称</td>
			<td align="center" width="3%">股东人数</td>
			<td align="center" width="10%">股份比例</td>
			<td align="center" width="4%">CEO</td>
			<td align="center" width="7%">董事会成员</td>
			<td align="center" width="8%">全职股东</td>
			<td align="center" width="4%">是否有期权池</td>
			<td align="center" width="9%">记录时间</td>
			<td align="center" width="4%">花费时间</td>
			<td align="center" width="3%">星级</td>
			<td align="center" width="3%">分数</td>
			<td align="center" width="5%">所属客服</td>
			<td align="center" width="5%">意向</td>
        ...
        <?php foreach ($data as $k=>$vo){?>
          <tr>
            ...
            <td align="center"><?php echo $vo['partner_num']?></td> 
            <td align="center">
            <?php 
            $stock_scale = explode(",",$vo['stock_scale']);
            foreach ($stock_scale as $k=>$s){
                echo "<p>".$s."</p>";
            }
            ?>
            </td> 
            <td align="center"><?php echo $vo['is_ceo']?></td> 
            <td align="center"><?php echo $vo['is_direct']?></td> 
            <td align="center"><?php echo $vo['is_full_time']?></td> 
            <td align="center"><?php echo $vo['is_pool'] == 1?"有":"无"?></td> 
			<td align="center"><?php echo date("Y-m-d H:i:s",$vo['datetime'])?></td>
			
            <td align="center"><?php echo $vo['cost_time']?>秒</td> 
            <td align="center"><?php echo $vo['star']?>星</td> 
            <td align="center"><?php echo $vo['score']?>分</td> 
