		...
		<div class="h_a">基本属性</div>
		   ...
		   <table width="100%" class="table_form contentWrap">
			<tbody> 
			  <th width="80">买家姓名</th>
			  <td>
				<input type="text" name="name" value="{$lists['name']}" class="listText" id="name"/>
			    <span id="errname"></span></td>
			  </tr>
			   <tr class="member">
			  <th>联系电话</th>
			  <td>
				 <input type="text" name="tel" value="{$lists['tel']}" class="listText" id="tel" />
			  ...
			  <td>
			   ...
			   <tr>
				<th>商品名称</th>         	
				<td><input type="text" name="pro_title" value="{$lists['pro_title']}" class="listText" id="pro_title"/>
			  ...
			  <th>商品价格</th>
			  <td>
				<input type="text" name="pro_price" value="{$lists['pro_price']}" class="listText" id="pro_price"/>
			  ...
			  <th>买家地址</th>
			  <td>
				<input type="text" name="address" value="{$lists['address']}" class="listText" id="address"/>		
                <span id="errads"></span>				
			  </td>
			  </tr>
			  <tr>
			  <th>付款方式</th>
			  <td>
				<input type="text" name="pay_type" value="{$lists['pay_type']}" class="listText" id="pay_type"/>					
			  </td>
			  </tr>
			  <tr>
					<th>支付状态</th>
						<td> 
						     <select class="select_1" name="status" id="status" style="width:80px">
							    <option <eq name="lists.status" value="1">selected</eq> value="1">已付款</option>
							    <option <eq name="lists.status" value="0">selected</eq> value="0">未付款</option>
							 </select>
						</td>          	         
				  </tr>
			<tr>
			  <th>备注</th>
			  <td><input name="des" type="text" value="{$lists['des']}" class="listText" id="des"/></td>
			</tr>           
				</tbody>
			  </table>
		   </div>
