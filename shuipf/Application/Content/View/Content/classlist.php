      ...
      <table width="100%">
        ...
        <thead>
          <tr>
            ...
            <!--{$catid}-->
            <?php  
                $pid = getCategory($catid,'parentid');
                //$fid = getCategory($pid,'parentid');
            ?>
            <if condition="$pid eq 7"><td>扫码链接</td></if>
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <if condition="$pid eq 7"><td align="center"><a href="/index.php?m=Saoma&a=show_saomadetail&catid={$vo.catid}&id={$vo.id}" target="_blank"><span style="" >{$vo.title}</span></a></td></if>
