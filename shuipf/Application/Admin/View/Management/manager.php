   ...
   <table width="100%" cellspacing="0">
        <thead>
          <tr>
            ...
            <td width="8%" align="left" >所属角色</td>
            <td width="8%"  align="left" >最后登录IP</td>
            <td width="13%"  align="left" >最后登录时间</td>
        ...
        <foreach name="Userlist" item="vo">
          <tr>
            <td width="8%" align="center">{$vo.id}</td>
            <td width="8%" >{$vo.username}</td>
            <td width="8%" ><?php echo D('Admin/Role')->getRoleIdName($vo['role_id'])?></td>
            <td width="8%" >{$vo.last_login_ip}</td>
            <td width="13%"  >
