		   ...
		   <table width="100%" class="table_form contentWrap">
				<tbody>
				 ...
				 <tr>
				  ...
				  <tr>
					<th width="100px">会员累计积分</th>         	
					<td>{$lists['total_score']}</td>
					<th width="100px">会员可用积分</th>         	
					<td>{$lists['score']}</td>
					<th width="100px">会员佣金</th>         	
					<td>{$lists['commission']}</td>
