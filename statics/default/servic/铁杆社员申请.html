...
<div class="cBox"> 
    ...
    <div class="ub ub-ver myApplyBox">
        <div class="myApply ub ub-pc ub-ac uinn bgc"><img src="../images/logo4.png" alt=""></div>
        ...
        <a class="btn ub ub-fl umar-b2 uinput" href="#"><input class="ub-f1 ub-ac ub-pc ulev-3 uc-a1 tx-cf" type="submit" name="" value="确认"></a>        
    </div>
    <!-- /我的-合伙社员申请-->
</div>
<!-- /c -->
